...
var obj_icons = [
    { type: GAVL_META_MEDIA_CLASS_AUDIO_FILE,      icon: "icon-volume-max"      },
    { type: GAVL_META_MEDIA_CLASS_VIDEO_FILE,      icon: "icon-film"            },
    { type: GAVL_META_MEDIA_CLASS_AUDIO_PODCAST_EPISODE,      icon: "icon-volume-max"      },
    { type: GAVL_META_MEDIA_CLASS_VIDEO_PODCAST_EPISODE,      icon: "icon-film"            },
    ...
    { type: GAVL_META_MEDIA_CLASS_IMAGE,           icon: "icon-image"           },
    { type: GAVL_META_MEDIA_CLASS_FILE,            icon: "icon-file"            },
    { type: GAVL_META_MEDIA_CLASS_LOCATION,        icon: "icon-globe"           },
    { type: GAVL_META_MEDIA_CLASS_MUSICALBUM,      icon: "icon-music-album"     }, 
    { type: GAVL_META_MEDIA_CLASS_PHOTOALBUM,      icon: "icon-photo"           }, 
    { type: GAVL_META_MEDIA_CLASS_PLAYLIST,           icon: "icon-playlist"     },
    { type: GAVL_META_MEDIA_CLASS_CONTAINER_ACTOR,    icon: "icon-person"       },
    { type: GAVL_META_MEDIA_CLASS_CONTAINER_DIRECTOR, icon: "icon-movie-maker"  },
    { type: GAVL_META_MEDIA_CLASS_CONTAINER_ARTIST,   icon: "icon-microphone"   },
    { type: GAVL_META_MEDIA_CLASS_CONTAINER_COUNTRY,  icon: "icon-flag"         },
    { type: GAVL_META_MEDIA_CLASS_CONTAINER_GENRE,    icon: "icon-masks"        },
    { type: GAVL_META_MEDIA_CLASS_CONTAINER_LANGUAGE, icon: "icon-talk"         },
    { type: GAVL_META_MEDIA_CLASS_CONTAINER_TAG,      icon: "icon-tag"          },
    { type: GAVL_META_MEDIA_CLASS_CONTAINER_YEAR,     icon: "icon-calendar"     },
    { type: GAVL_META_MEDIA_CLASS_CONTAINER_RADIO,    icon: "icon-radio"        },
    { type: GAVL_META_MEDIA_CLASS_CONTAINER_TV,       icon: "icon-tv"           },
    { type: GAVL_META_MEDIA_CLASS_PODCAST,            icon: "icon-rss"    },
    { type: GAVL_META_MEDIA_CLASS_TV_SHOW,            icon: "icon-tv"           },
    { type: GAVL_META_MEDIA_CLASS_AUDIO_RECORDER,     icon: "icon-microphone"   },
    { type: GAVL_META_MEDIA_CLASS_VIDEO_RECORDER,     icon: "icon-videocamera"  },
...
/* Root Containers */
    ...
    { type: GAVL_META_MEDIA_CLASS_ROOT_FAVORITES,    icon: "icon-heart"       }, 
    { type: GAVL_META_MEDIA_CLASS_ROOT_BOOKMARKS,    icon: "icon-bookmark"    }, 
    { type: GAVL_META_MEDIA_CLASS_ROOT_LIBRARY,      icon: "icon-library"     },
    { type: GAVL_META_MEDIA_CLASS_ROOT_SERVER,       icon: "icon-server"      },
    { type: GAVL_META_MEDIA_CLASS_ROOT_PLAYQUEUE,    icon: "icon-player"      },
    { type: GAVL_META_MEDIA_CLASS_ROOT_RECORDERS,    icon: "icon-videocamera" },

    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE,    icon: "icon-hdd"          },
    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE_AUDIOCD, icon: "icon-cdrom"  },
    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE_VCD, icon: "icon-cdrom"  },
    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE_SVCD, icon: "icon-cdrom"  },
    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE_VIDEODVD, icon: "icon-cdrom"  },

    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE_FILESYSTEM,            icon: "icon-hdd"     },
    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE_FILESYSTEM_HDD,        icon: "icon-hdd"     },
    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE_FILESYSTEM_PENDRIVE,   icon: "icon-pendrive" },
    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE_FILESYSTEM_MEMORYCARD, icon: "icon-memorycard" },
    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE_FILESYSTEM_MOBILE,     icon: "icon-mobile"  },
    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE_FILESYSTEM_CD,         icon: "icon-cdrom"  },
    { type: GAVL_META_MEDIA_CLASS_ROOT_REMOVABLE_FILESYSTEM_DVD,        icon: "icon-cdrom"  },
  ];
