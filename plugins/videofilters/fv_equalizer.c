...
static const bg_parameter_info_t parameters[] =
  {
    ...
    },
    {
      ...
      .type = BG_PARAMETER_SLIDER_FLOAT,
      .flags = BG_PARAMETER_SYNC,
      .val_min = GAVL_VALUE_INIT_FLOAT(-180.0),
      .val_max = GAVL_VALUE_INIT_FLOAT(180.0),
      .val_default = GAVL_VALUE_INIT_FLOAT(0.0),
      .num_digits = 1,
    },
    { /* End of parameters */ },
...
static void set_format(void * priv, const gavl_video_format_t * format)
  ...
  gavl_log(GAVL_LOG_DEBUG, LOG_DOMAIN, "Pixelformat: %s",
