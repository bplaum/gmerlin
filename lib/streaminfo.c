...
char * bg_get_track_name_default(const char * location)
  ...
  if(gavl_dictionary_get_int(&url_vars, GAVL_URL_VAR_TRACK, &track))
    {
    ret = gavl_sprintf("%s [%d]", tmp_string, track);
    free(tmp_string);
    return ret;
    }
  else
...
icons[] =
  {
/* Value for class */
    { GAVL_META_CLASS_AUDIO_FILE,             BG_ICON_MUSIC     },
    { GAVL_META_CLASS_VIDEO_FILE,             BG_ICON_FILM      },
    { GAVL_META_CLASS_AUDIO_PODCAST_EPISODE,  BG_ICON_MUSIC     },
    { GAVL_META_CLASS_VIDEO_PODCAST_EPISODE,  BG_ICON_FILM      },

    { GAVL_META_CLASS_SONG,               BG_ICON_MUSIC         },
    { GAVL_META_CLASS_MOVIE,              BG_ICON_FILM          },
    { GAVL_META_CLASS_MOVIE_PART,         BG_ICON_FILM          },
    { GAVL_META_CLASS_TV_EPISODE,         BG_ICON_TV            },
    { GAVL_META_CLASS_AUDIO_BROADCAST,    BG_ICON_RADIO },
    { GAVL_META_CLASS_VIDEO_BROADCAST,    BG_ICON_RADIO_STATION },
    //    { GAVL_META_CLASS_VIDEO_BROADCAST,  },
    { GAVL_META_CLASS_IMAGE,              BG_ICON_IMAGE,        },
    { GAVL_META_CLASS_FILE,               BG_ICON_FILE,         },
    { GAVL_META_CLASS_LOCATION,           BG_ICON_GLOBE,        },
    { GAVL_META_CLASS_AUDIO_DISK_TRACK,   BG_ICON_MUSIC         },
    { GAVL_META_CLASS_VIDEO_DISK_TRACK,   BG_ICON_FILM          },
    
/* Container values */
//    { GAVL_META_CLASS_CONTAINER,  },
    { GAVL_META_CLASS_MUSICALBUM,         BG_ICON_MUSIC_ALBUM },
    { GAVL_META_CLASS_PHOTOALBUM,         BG_ICON_PHOTO       },
    { GAVL_META_CLASS_PLAYLIST,           BG_ICON_PLAYLIST    },
    { GAVL_META_CLASS_CONTAINER_ACTOR,    BG_ICON_PERSON      }, 
    { GAVL_META_CLASS_CONTAINER_DIRECTOR, BG_ICON_MOVIE_MAKER }, 
    { GAVL_META_CLASS_CONTAINER_ARTIST,   BG_ICON_MICROPHONE  },
    { GAVL_META_CLASS_CONTAINER_COUNTRY,  BG_ICON_FLAG        },
    { GAVL_META_CLASS_CONTAINER_GENRE,    BG_ICON_MASKS       },
    { GAVL_META_CLASS_CONTAINER_LANGUAGE, BG_ICON_TALK        },
    { GAVL_META_CLASS_CONTAINER_TAG,      BG_ICON_TAG         },
    { GAVL_META_CLASS_CONTAINER_YEAR,     BG_ICON_CALENDAR    },
    { GAVL_META_CLASS_CONTAINER_RADIO,    BG_ICON_RADIO       },
    { GAVL_META_CLASS_CONTAINER_TV,       BG_ICON_TV          },

    { GAVL_META_CLASS_PODCAST,            BG_ICON_RSS   },

    { GAVL_META_CLASS_TV_SEASON,          BG_ICON_TV          },
    { GAVL_META_CLASS_TV_SHOW,            BG_ICON_TV          },
    { GAVL_META_CLASS_AUDIO_RECORDER,     BG_ICON_MICROPHONE  },
    { GAVL_META_CLASS_VIDEO_RECORDER,     BG_ICON_VIDEOCAMERA },
    //    { GAVL_META_CLASS_DIRECTORY },
    
/* Root Containers */
//    { GAVL_META_CLASS_ROOT  },
    { GAVL_META_CLASS_ROOT_PLAYQUEUE,         BG_ICON_PLAYER   }, 
    { GAVL_META_CLASS_ROOT_MUSICALBUMS,       BG_ICON_MUSIC_ALBUM   }, 
    { GAVL_META_CLASS_ROOT_SONGS,             BG_ICON_MUSIC         },
    { GAVL_META_CLASS_ROOT_MOVIES,            BG_ICON_FILM          },
    { GAVL_META_CLASS_ROOT_TV_SHOWS,          BG_ICON_TV            },
    { GAVL_META_CLASS_ROOT_STREAMS,           BG_ICON_NETWORK },
    { GAVL_META_CLASS_ROOT_PODCASTS,          BG_ICON_RSS   },

    { GAVL_META_CLASS_ROOT_FAVORITES,         BG_ICON_HEART         }, 
    { GAVL_META_CLASS_ROOT_BOOKMARKS,         BG_ICON_BOOKMARK      }, 
    { GAVL_META_CLASS_ROOT_LIBRARY,           BG_ICON_LIBRARY       },
    { GAVL_META_CLASS_ROOT_SERVER,            BG_ICON_SERVER      },
    
    { GAVL_META_CLASS_ROOT_DIRECTORIES,       BG_ICON_HDD           },
    { GAVL_META_CLASS_ROOT_PHOTOS,            BG_ICON_PHOTO         },

    { GAVL_META_CLASS_ROOT_RECORDERS,         BG_ICON_VIDEOCAMERA    },

    
    { GAVL_META_CLASS_ROOT_REMOVABLE,     BG_ICON_HDD           },
    { GAVL_META_CLASS_ROOT_REMOVABLE_AUDIOCD, BG_ICON_CDROM     },
    { GAVL_META_CLASS_ROOT_REMOVABLE_VCD, BG_ICON_CDROM     },
    { GAVL_META_CLASS_ROOT_REMOVABLE_SVCD,BG_ICON_CDROM     },
    { GAVL_META_CLASS_ROOT_REMOVABLE_VIDEODVD,BG_ICON_CDROM     },

    { GAVL_META_CLASS_ROOT_REMOVABLE_FILESYSTEM,     BG_ICON_HDD           },
    { GAVL_META_CLASS_ROOT_REMOVABLE_FILESYSTEM_HDD, BG_ICON_HDD           },
    { GAVL_META_CLASS_ROOT_REMOVABLE_FILESYSTEM_PENDRIVE, BG_ICON_PENDRIVE },
    { GAVL_META_CLASS_ROOT_REMOVABLE_FILESYSTEM_MEMORYCARD, BG_ICON_MEMORYCARD },
    { GAVL_META_CLASS_ROOT_REMOVABLE_FILESYSTEM_MOBILE, BG_ICON_MOBILE },
    { GAVL_META_CLASS_ROOT_REMOVABLE_FILESYSTEM_CD, BG_ICON_CDROM },
    { GAVL_META_CLASS_ROOT_REMOVABLE_FILESYSTEM_DVD, BG_ICON_CDROM },

    /* Backends */
    { GAVL_META_CLASS_BACKEND_RENDERER, BG_ICON_PLAYER },
    { GAVL_META_CLASS_BACKEND_MDB,      BG_ICON_SERVER },
